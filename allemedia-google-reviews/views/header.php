...
$review_link = isset( $header_data['review'] ) ? (string) $header_data['review'] : '';
?>
<header class="amr-reviews__header">
    <div class="amr-reviews__header-grid">
        <div class="amr-reviews__summary-card" aria-live="polite">
            <div class="amr-reviews__summary-top">
                <span class="amr-reviews__summary-badge">
                    <span class="amr-reviews__summary-icon" aria-hidden="true">
                    ...
                    <span class="amr-reviews__summary-label"><?php esc_html_e( 'Opinie Google', 'allemedia-reviews' ); ?></span>
                </span>
                <span class="amr-reviews__summary-status"><?php esc_html_e( 'Zweryfikowane opinie', 'allemedia-reviews' ); ?></span>
            </div>
            <div class="amr-reviews__summary-rating" role="img" aria-label="<?php echo esc_attr( sprintf( __( 'Średnia ocena: %1$s na 5', 'allemedia-reviews' ), number_format_i18n( $average, 1 ) ) ); ?>">
                <span class="amr-reviews__summary-score" aria-hidden="true"><?php echo esc_html( number_format_i18n( $average, 1 ) ); ?></span>
                <div class="amr-reviews__summary-stars">
                    <?php echo render_stars( $average, $star_id ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
                </div>
            </div>
            <p class="amr-reviews__summary-count">
                <?php printf( esc_html__( 'na podstawie %s opinii', 'allemedia-reviews' ), esc_html( number_format_i18n( $total ) ) ); ?>
            </p>
            <?php if ( ! empty( $review_link ) ) : ?>
                <a class="amr-reviews__summary-cta" href="<?php echo esc_url( $review_link ); ?>" target="_blank" rel="noopener noreferrer">
                    <?php esc_html_e( 'Napisz opinię w Google', 'allemedia-reviews' ); ?>
                </a>
            <?php endif; ?>
        </div>
        <div class="amr-reviews__intro">
            <p class="amr-reviews__eyebrow"><?php esc_html_e( 'Dziękujemy za wszystkie opinie!', 'allemedia-reviews' ); ?></p>
            ...
            <p class="amr-reviews__subtitle"><?php esc_html_e( 'Poznaj doświadczenia naszych klientów prosto z wizytówki Google.', 'allemedia-reviews' ); ?></p>
        </div>
    </div>
</header>
