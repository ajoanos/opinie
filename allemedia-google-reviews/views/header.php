...
<header class="amr-reviews__header">
    <div class="amr-reviews__top">
        <div class="amr-reviews__brand">
            <span class="amr-reviews__brand-icon" aria-hidden="true">
            ...
            <span class="amr-reviews__brand-text"><?php esc_html_e( 'Opinie z Google', 'allemedia-reviews' ); ?></span>
        </div>
        <?php if ( ! empty( $review_link ) ) : ?>
            <a class="amr-reviews__cta" href="<?php echo esc_url( $review_link ); ?>" target="_blank" rel="noopener noreferrer">
                <?php esc_html_e( 'Oceń nas w Google', 'allemedia-reviews' ); ?>
            </a>
        <?php endif; ?>
    </div>
    ...
    <p class="amr-reviews__subtitle"><?php esc_html_e( 'Najnowsze opinie naszych klientów prosto z Google.', 'allemedia-reviews' ); ?></p>
    <div class="amr-reviews__summary" aria-live="polite">
        <div class="amr-reviews__rating" role="img" aria-label="<?php echo esc_attr( sprintf( __( 'Średnia ocena: %1$s na 5', 'allemedia-reviews' ), number_format_i18n( $average, 1 ) ) ); ?>">
            <span class="amr-reviews__rating-value" aria-hidden="true"><?php echo esc_html( number_format_i18n( $average, 1 ) ); ?></span>
            <div class="amr-reviews__stars">
                <?php echo render_stars( $average, $star_id ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
            </div>
        </div>
        <div class="amr-reviews__details">
            ...
            <span class="amr-reviews__badge"><?php esc_html_e( 'Najnowsze opinie', 'allemedia-reviews' ); ?></span>
        </div>
    </div>
</header>
